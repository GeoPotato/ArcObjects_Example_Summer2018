...
//
// This code controls the band combinations for Landsat 8.

namespace ArcMap_Raster_Button
{
    class Sensor_Landsat8
    {
        ...
        public void Landsat8_Combinations(GUI_AddRaster theGUI)
        {
            ...
            if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_1)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 6 - indexOne, 5 - indexOne, 2 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_2)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 6 - indexOne, 3 - indexOne, 2 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_3)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 7 - indexOne, 5 - indexOne, 2 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_4)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 5 - indexOne, 6 - indexOne, 2 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_5)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 5 - indexOne, 6 - indexOne, 4 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_8)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 7 - indexOne, 6 - indexOne, 4 - indexOne);
