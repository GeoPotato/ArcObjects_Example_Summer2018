...
//
// This code controls how the RGB combination textboxes will populate with Burn Scarring combobox selection.

namespace ArcMap_Raster_Button
{
    class Class_AssignTextBoxRGB_BurnScarring
    {
        ...
        public void RGB_Assignments_BurnScarring(GUI_AddRaster theGUI)
        {
