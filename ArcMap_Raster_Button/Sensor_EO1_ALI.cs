...
//
// This code controls the band combinations for EO-1 ALI.

namespace ArcMap_Raster_Button
{
    class Sensor_EO1_ALI
    {
        ...
        public void EO1_ALI_Combinations(GUI_AddRaster theGUI)
        {
            ...
            if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_1)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 9 - indexOne, 7 - indexOne, 3 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_2)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 9 - indexOne, 4 - indexOne, 3 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_3)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 10 - indexOne, 7 - indexOne, 3 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_4)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 7 - indexOne, 9 - indexOne, 3 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_5)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 7 - indexOne, 9 - indexOne, 5 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_6)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 5 - indexOne, 4 - indexOne, 3 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_7)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 10 - indexOne, 7 - indexOne, 4 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_8)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 10 - indexOne, 9 - indexOne, 5 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_9)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 7 - indexOne, 5 - indexOne, 4 - indexOne);
