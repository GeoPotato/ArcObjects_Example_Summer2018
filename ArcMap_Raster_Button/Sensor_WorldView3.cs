...
//
// This code controls the band combinations for WorldView-3.

namespace ArcMap_Raster_Button
{
    class Sensor_WorldView3
    {
        ...
        public void WorldView3_Combinations(GUI_AddRaster theGUI)
        {
            ...
            if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_1)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 10 - indexOne, 7 - indexOne, 2 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_2)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 10 - indexOne, 3 - indexOne, 2 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_3)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 13 - indexOne, 7 - indexOne, 2 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_4)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 7 - indexOne, 10 - indexOne, 2 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_5)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 7 - indexOne, 10 - indexOne, 5 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_7)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 13 - indexOne, 7 - indexOne, 3 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_8)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 13 - indexOne, 10 - indexOne, 5 - indexOne);
