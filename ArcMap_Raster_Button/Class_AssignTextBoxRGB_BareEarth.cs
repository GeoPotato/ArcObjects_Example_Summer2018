...
//
// This code controls how the RGB combination textboxes will populate with Bare Earth combobox selection.

namespace ArcMap_Raster_Button
{
    class Class_AssignTextBoxRGB_BareEarth
    {
        ...
        public void RGB_Assignments_BareEarth(GUI_AddRaster theGUI)
        {
