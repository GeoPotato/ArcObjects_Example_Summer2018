...
//
// This code controls the band combinations for FormoSat-1.

namespace ArcMap_Raster_Button
{
    class Sensor_FormoSat1
    {
        ...
        public void FormoSat1_Combinations(GUI_AddRaster theGUI)
        {
            ...
            if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_6)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 5 - indexOne, 4 - indexOne, 2 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_9)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 6 - indexOne, 5 - indexOne, 4 - indexOne);
