...
//
// This code controls the band combinations for Landsat 4-5 TM.

namespace ArcMap_Raster_Button
{
    class Sensor_Landsat4_5_TM
    {
        ...
        public void Landsat4_5_TM_Combinations(GUI_AddRaster theGUI)
        {
            ...
            if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_1)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 5 - indexOne, 4 - indexOne, 1 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_2)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 5 - indexOne, 2 - indexOne, 1 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_3)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 7 - indexOne, 4 - indexOne, 1 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_4)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 4 - indexOne, 5 - indexOne, 1 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_5)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 4 - indexOne, 5 - indexOne, 3 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_7)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 7 - indexOne, 4 - indexOne, 2 - indexOne);
