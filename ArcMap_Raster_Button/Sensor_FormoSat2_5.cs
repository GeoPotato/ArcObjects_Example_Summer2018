...
//
// This code controls the band combinations for Formosat-2 and FormoSat-5.

namespace ArcMap_Raster_Button
{
    class Sensor_FormoSat2_5
    {
        ...
        public void FormoSat2_5_Combinations(GUI_AddRaster theGUI)
        {
