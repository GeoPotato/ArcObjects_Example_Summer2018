...
//
// This code controls the band combinations for EO-1 Hyperion.

namespace ArcMap_Raster_Button
{
    class Sensor_EO1_Hyperion
    {
        ...
        public void EO1_Hyperion_Combinations(GUI_AddRaster theGUI)
        {
            ...
            if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_1)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 150 - indexOne, 50 - indexOne, 16 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_2)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 150 - indexOne, 23 - indexOne, 16 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_3)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 204 - indexOne, 50 - indexOne, 16 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_4)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 50 - indexOne, 150 - indexOne, 16 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_5)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 50 - indexOne, 150 - indexOne, 29 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_6)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 29 - indexOne, 23 - indexOne, 16 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_7)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 204 - indexOne, 50 - indexOne, 23 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_8)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 204 - indexOne, 150 - indexOne, 29 - indexOne);
            ...
            else if (theGUI.combo_StudyType.SelectedItem.ToString() == GUI_AddRaster.STUDYTYPE_9)
            {
                ...
                //run_BandCombinationClass.bandCombination(theGUI, 50 - indexOne, 29 - indexOne, 23 - indexOne);
