...
//
// This code controls how the RGB combination textboxes will populate with Healthy Vegetation combobox selection.

namespace ArcMap_Raster_Button
{
    class Class_AssignTextBoxRGB_HealthyVegetation
    {
        ...
        public void RGB_Assignments_HealthyVegetation(GUI_AddRaster theGUI)
        {
