...
//
// This code controls how the RGB combination textboxes will populate with Land - Water Boundaries combobox selection.

namespace ArcMap_Raster_Button
{
    class Class_AssignTextBoxRGB_LandWaterBoundaries
    {
        ...
        public void RGB_Assignments_LandWaterBoundaries(GUI_AddRaster theGUI)
        {
