...
//
// This code controls how the RGB combination textboxes will populate with Natural Color - No Atmosphere combobox selection.

namespace ArcMap_Raster_Button
{
    class Class_AssignTextBoxRGB_NaturalColorNoAtmosphere
    {
        ...
        public void RGB_Assignments_NaturalColorNoAtmosphere(GUI_AddRaster theGUI)
        {
